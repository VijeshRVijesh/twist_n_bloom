...
import { Sparkles, Menu, X, Gift } from "lucide-react";
            ...
            {navLinks.map((link) => {
              ...
              return isHashLink ? (
                <a
                  key={link.name}
                  href={link.href}
                  className="text-sm font-medium transition-colors relative py-1 text-[#6C5D60] hover:text-[#7A2036]"
                >
                  {link.name}
                </a>
              ) : (
            ...
            {navLinks.map((link) => {
              ...
              return isHashLink ? (
                <a
                  ...
                  className="text-base font-medium py-2 px-3 rounded-lg transition-colors text-[#6C5D60] hover:bg-[#F6E6E8]/50"
                >
                  {link.name}
                </a>
              ) : (
