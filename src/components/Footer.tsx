...
import { Gift, Heart, Mail, Send, CheckCircle2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                <Link to="/" className="hover:text-[#D89A9E] transition-colors">
                  Home Landing
                </Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-[#D89A9E] transition-colors">
                  About Our Studio
                </Link>
              </li>
              <li>
                <a href="/#customizer" className="hover:text-[#D89A9E] transition-colors">
                  Interactive Hamper Builder
                </a>
              </li>
              <li>
                <a href="/#occasions" className="hover:text-[#D89A9E] transition-colors">
                  Special Event Occasions
                </a>
              </li>
              <li>
                <Link to="/contact" className="hover:text-[#D89A9E] transition-colors">
